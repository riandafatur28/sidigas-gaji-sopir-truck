...
@section('title', 'Hasil LLM Parser Ritase')
...
<div class="max-w-5xl mx-auto">
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <div class="flex items-center gap-2 mt-1">
                @if (isset($results['source']) && $results['source'] === 'llm')
                <span class="px-2 py-0.5 text-xs font-semibold rounded bg-purple-100 text-purple-800">🤖 LLM</span>
                @else
                <span class="px-2 py-0.5 text-xs font-semibold rounded bg-green-100 text-green-800">⚙️ Rule-based</span>
                @endif
        ...
        <a href="{{ route('ritase.llm.form') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">← Kembali</a>
    </div>
    ...
    <div class="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <p class="text-yellow-800">
            ...
            <a href="{{ route('ritase.parser') }}" class="underline">Coba parser konvensional</a> sebagai pembanding.
        </p>
    </div>
    @endif
    ...
    <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        ...
        <div class="mt-2 flex gap-3">
            ...
            <a href="{{ route('ritase.llm.form') }}" class="text-green-600 hover:underline">Parse Lagi</a>
            <span class="text-gray-400">|</span>
            <a href="{{ route('ritase.parser') }}" class="text-green-600 hover:underline">Parser Konvensional</a>
        </div>
    </div>
    @else
    <div class="mt-6 flex justify-end gap-3">
        <form action="{{ route('ritase.llm.process') }}" method="POST" class="inline">
            @csrf
        ...
        <a href="{{ route('ritase.llm.form') }}" class="px-6 py-2 bg-gray-200 text-gray-700 font-medium rounded-md hover:bg-gray-300">
            Edit Ulang
        </a>
    </div>
    @endif
